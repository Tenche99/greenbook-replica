...
console.log('API DOMAIN ++++' + process.env.BACKEND_API_DOMAIN)
const API_DOMAIN = process.env.BACKEND_API_DOMAIN || 'localhost'
export const sAPIBASEURL = `http://${API_DOMAIN}/api`
...
export const oTableIcons = {
  Refresh: forwardRef((props, ref) => (
    <Refresh {...props} color={'primary'} ref={ref} />
  )),
  ...
  Email: forwardRef((props, ref) => (
    <EmailIcon {...props} color={'primary'} ref={ref} />
  )),
  ...
  SortArrow: forwardRef((props, ref) => (
    <ArrowDownward {...props} color={'primary'} ref={ref} />
  )),
...
export const MadebReportColumns = [
  ...
  },
  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebPending
        .toString()
        .localeCompare(b.madebPending.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
  ...
  },
  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebIssued
        .toString()
        .localeCompare(b.madebIssued.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
  ...
  },
  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebRejected
        .toString()
        .localeCompare(b.madebRejected.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
  ...
  },
  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebDouble
        .toString()
        .localeCompare(b.madebDouble.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
  ...
  },
  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebCancelled
        .toString()
        .localeCompare(b.madebCancelled.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
...

  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebClosed
        .toString()
        .localeCompare(b.madebClosed.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
...

  {
    ...
    customSort: (a, b) => {
      ...
      return a.madebTotalReceived
        .toString()
        .localeCompare(b.madebTotalReceived.toString(), 'en', { numeric: true })
    },
    headerStyle: {
      padding: '5px',
