...
const Sarso = () => {
  ...
  <Table sx={{ borderCollapse: "collapse", border: "1px solid black" }}>
    ...
    <TableRow
      ...
      >
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Form Number</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Received Date</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Authority</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Full Name</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Father's Name</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Saney Form No</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Document Attached</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Status</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center", whiteSpace: "normal" }}>Book Serial No</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>GB ID</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Issue Action Date</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Issue Action</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Return Date</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Reject Date</TableCell>
        <TableCell sx={{ fontWeight: "bold", border: "1px solid black", textAlign: "center" }}>Email Sent</TableCell>
      </TableRow>
    </TableHead>
    <TableBody>
      {data.map((row) => (
        <TableRow key={row.madeb.id}>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.nFormNumber}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.dtReceived ? moment(row.madeb.dtReceived).format('MM/DD/YYYY') : ''}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.sAuthRegion}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.sName}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.sFathersName}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.nSaneyFormNo}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.sDocumentAttached}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.sMadebStatus}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.nCurrentGBSno}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.sGBID}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.dtIssueAction ? moment(row.madeb.dtIssueAction).format('MM/DD/YYYY') : ''}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.sTypeIssued}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.dtReturnEmail ? moment(row.madeb.dtReturnEmail).format('MM/DD/YYYY') : ''}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.dtReject ? moment(row.madeb.dtReject).format('MM/DD/YYYY') : ''}</TableCell>
          <TableCell sx={{ border: "1px solid black", textAlign: "center" }}>{row.madeb.dtEmailSend ? moment(row.madeb.dtEmailSend).format('MM/DD/YYYY') : ''}</TableCell>
